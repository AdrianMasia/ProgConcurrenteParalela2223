...
// ============================================================================
class MiHebraCopiada extends Thread {
// ============================================================================
  int                  tope;
  CopiaCuentaIncrementos  c;

  // --------------------------------------------------------------------------
  public MiHebraCopiada( int tope, CopiaCuentaIncrementos c ) {
    this.tope  = tope;
    this.c     = c;
  }
...
// ============================================================================
class EjemploCopiaCuentaIncrementos {
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    t1 = System.nanoTime();
    MiHebraCopiada v[] = new MiHebraCopiada[ numHebras ];
    CopiaCuentaIncrementos c = new CopiaCuentaIncrementos();
    for( int i = 0; i < numHebras; i++ ) {
      v[ i ] = new MiHebraCopiada( tope, c );
      v[ i ].start();
    }
    for( int i = 0; i < numHebras; i++ ) {
      try {
