...
// ============================================================================
class MiHebraAtom extends Thread {
// ============================================================================
  int                  tope;
  AtomicInteger  c;

  // --------------------------------------------------------------------------
  public MiHebraAtom( int tope, AtomicInteger c ) {
    this.tope  = tope;
    this.c     = c;
  }
...
// ============================================================================
class EjemploAtomCuentaIncrementos {
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    t1 = System.nanoTime();
    MiHebraAtom v[] = new MiHebraAtom[ numHebras ];
    AtomicInteger c = new AtomicInteger(0);
    for( int i = 0; i < numHebras; i++ ) {
      v[ i ] = new MiHebraAtom( tope, c );
      v[ i ].start();
    }
    for( int i = 0; i < numHebras; i++ ) {
      try {
